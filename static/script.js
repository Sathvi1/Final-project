...
async function uploadCertificateInfo() {
    ...
    console.log("Generated QR Code : ", generated_qr_code);
}
...
async function generateCertificate() {
    ...
    console.log("Generated QR CODE certificate: ", generated_qr_code);
    ...
    console.log("Generated QR CODE Source : ", generated_qr_code_img.src);
    generated_qr_code_img.src = "/static/certificate_template.png";
    ...
    templateImage.onload = function () {
        ...
        certificateContext.drawImage(generated_qr_code_img, 1500, 1010, 320, 320);
